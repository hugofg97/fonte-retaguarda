...
import { Box, Typography, TextField,  makeStyles, withStyles, Button, CircularProgress } from '@material-ui/core';
  ...
  return (
    ...
    <Box display="flex" marginTop={10} flexDirection="column">
      ...
      <CustomTextField
            ...
            label="Senha"
            variant="outlined"/>
             {isLoading? <CircularProgress style={{color: 'green'}}></CircularProgress>:<Button
          disabled={!isValid}
          className={paymentClass.button}
          variant="outlined" color="primary" onClick={handleSubmit(onSubmit)}>Prosseguir</Button>}
