...
export default function NewVideo() {
  ...
  const {createNewVideo, getVideos, msgError, setMsgError} = React.useContext(VideoContext)
  ...
  const handleClose = () => {
    setMsgError("");
    setOpen(false);
    setVideo({name: '', description:'', videoThumb: '',locked: false, videoUrl: ''});
    setSelectedImage(null);
  };
  const saveVideo = async () => {
    setIsLoading(true);
    await createNewVideo({video,sessionId, selectedImage});
    ...
    <div>
      ...
      <Dialog open={open} onClose={handleClose} fullWidth>
        ...
        <input
          ...
          {...register("videoThumb")}
          onChange={handleChange('videoThumb')}
          id="outlined-error-helper-text"
          label="Url Capa"
          variant="outlined"
        />
